		...
		options: [
			{
				...
				options: [
					...
					{ name: 'Transfer In', value: '5' },
					{ name: 'Transfer Out', value: '6' },
					{ name: 'Liquidation Deduction', value: '7' },
					{ name: 'Margin Fee Deduction', value: '8' },
					{ name: 'Forced Liquidation', value: '9' },
					{ name: 'Delivery', value: '11' },
					{ name: 'Clawback', value: '14' },
					{ name: 'Fee', value: '30' },
				],
				default: [],
...
export async function execute(
	...
	if (additionalFields.type && (additionalFields.type as string[]).length > 0) {
		body.type = (additionalFields.type as string[]).join(',');
	}
